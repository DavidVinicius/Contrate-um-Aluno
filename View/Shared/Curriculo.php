...
<!--                        <label for="data">Data de Nascimento </label>-->
                ...
                <div class="row">
                    ...
                    <div class="col m6">
                        ...
                        <div class="input-field col s12 m12">
                            ...
                            <input type="text" name="ano" id="data" ng-model="anoC"> </div>
                        <div class="input-field col s12 m12">
                            <label for="titulo">Formação</label>
                            <input type="text" class='validate length' id="titulo" ng-model='curso' length="25"> </div>
                        <div class="input-field col s12 m12">
                            <label for="instituicao">Instituição</label>
                            <input type="text" class='validate length' id="instituicao" ng-model="escola" length="30"> </div> <a class="btn blue" ng-click='adicionarFormacao()'>Adicionar Formação</a> </div>
                </div>
                <div class="row">
                    <div class="col s12 m6">
                ...
                <div class="row">
                    <div class="input-field col s12 m12">
                        ...
                        <input type="text" value="{{Experiencia}}" name="Experiencias" id=""> </div>
                    <div class=" center-align">
                        <input type="submit" value="Salvar Informações" class="btn blue"> </div>
                </div>
            </form>
        </div>
