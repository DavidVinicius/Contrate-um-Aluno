 ...
 */
    class ModelAluno
    {
        ...
        public function CreateAluno($DataNascimento, $InformacoesAdicionais,
        $Foto, $Nome, $Cpf, $Objetivo, $Qualificacoes, $Rg, $CodCurso,$CodUsuario)
        {
            $Dados = array(
        ...
        public function UpdateAluno($Field, $NewValue)
        {
            $Id = $this->getIdAluno();
            $DB = $this->InstanciaDB();
