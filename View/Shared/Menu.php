           ...
           <nav>
            ...
            <div class='nav-wrapper menuCor'>
              ...
              <ul class='right hide-on-med-and-down'>
               ...
               <li><a href='' data-activates='Configuracoes' class='abrir'><img src='Images/Upload/".$fotoAluno."' class='circle responsive-img valign' width='40px' style='margin-top:10px'><span class='badge red circle white-text'>2</span></a></li>
              ...
              <ul class='side-nav' id='menuLateral'>
               <li><div class='userView'>
                  <img class='background responsive-img' src='Images/Upload/Office.jpg'>
           ...
           <nav>
            ...
            <div class='nav-wrapper menuCor'>
              ...
              <ul class='right hide-on-med-and-down'>
                ...
                <li><a href='OnePage.php?link=Perfil'>Perfil</a></li>
               <li><a href='' data-activates='Configuracoes' class='abrir'><img src='Images/Upload/".$fotoEmpresa."' class='circle responsive-img valign' width='40px' style='margin-top:10px'><span class='badge red circle white-text'>2</span></a></li>
                <li><a href='./Controller/Sair.php'>Sair</a></li>
                <li><span style='margin-right:5%'>&nbsp &nbsp</span></li>
              </ul>
              <ul class='side-nav' id='menuLateral'>
